 ...
 */
package com.shinnlove.springall.util.wxpay.sdkplus.util;
...
public class WXPayUtil {
    ...
    public static String generateSignedXml(final Map<String, String> data, String key)
                                                                                      throws Exception {
        return generateSignedXml(data, key, WXPaySignType.MD5);
    }
    ...
    public static boolean isSignatureValid(Map<String, String> data, String key) throws Exception {
        return isSignatureValid(data, key, WXPaySignType.MD5);
    }
    ...
    public static String generateSignature(final Map<String, String> data, String key)
                                                                                      throws Exception {
        return generateSignature(data, key, WXPaySignType.MD5);
    }
    ...
    public static String generateSignature(final Map<String, String> data, String key,
        ...
        if (WXPaySignType.MD5.equals(signType)) {
            return MD5(sb.toString()).toUpperCase();
        } else if (WXPaySignType.HMACSHA256.equals(signType)) {
